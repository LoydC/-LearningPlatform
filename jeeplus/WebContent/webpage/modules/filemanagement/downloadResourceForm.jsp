...
<body class="hideScroll">
        <form:form id="inputForm" modelAttribute="educationResource" action="${ctx}/filemanagement/educationResource/download" target="_blank" method="post" class="form-horizontal">
        <form:hidden path="id"/>
