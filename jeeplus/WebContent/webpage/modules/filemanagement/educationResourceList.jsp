	...
	<table id="contentTable" class="table table-striped table-bordered table-hover table-condensed dataTables-example dataTable">
		<thead>
			<tr>
				...
				<th  class="sort-column uploadFilename">上传资源的名称</th>
				<th>操作</th>
			</tr>
		</thead>
		<tbody>
		<c:forEach items="${page.list}" var="educationResource">
			<tr>
				...
				<td>
					${educationResource.uploadFilename}
				</td>
				<td>
					<shiro:hasPermission name="filemanagement:educationResource:view">
						<a href="#" onclick="openDialogView('查看教学资源增删改查', '${ctx}/filemanagement/educationResource/form?id=${educationResource.id}&display=true','800px', '500px')" class="btn btn-info btn-xs" ><i class="fa fa-search-plus"></i> 查看</a>
					</shiro:hasPermission>
					<shiro:hasPermission name="filemanagement:educationResource:edit">
